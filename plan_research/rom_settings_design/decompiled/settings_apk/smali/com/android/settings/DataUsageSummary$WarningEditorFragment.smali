...
.method public constructor <init>(Lcom/android/settings/DataUsageSummary;)V
    ...
    .prologue
    .line 2289
    iput-object p1, p0, Lcom/android/settings/DataUsageSummary$WarningEditorFragment;->this$0:Lcom/android/settings/DataUsageSummary;
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    const-string v18, "WarningEditorFragment onCreateDialog: maxValue = "
    ...
    .line 2336
    .local v5, "warningValue":I
    invoke-static {v5}, Ljava/lang/String;->valueOf(I)Ljava/lang/String;

    move-result-object v17

    .line 2337
    .local v17, "warningValueStr":Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v9}, Lcom/android/settings/DataUsageSummary$WarningEditorFragment$1;-><init>(Lcom/android/settings/DataUsageSummary$WarningEditorFragment;Landroid/widget/EditText;Landroid/content/Context;IILcom/android/settings/net/NetworkPolicyEditor;Landroid/net/NetworkTemplate;Lcom/android/settings/DataUsageSummary;)V
    ...
    new-instance v1, Lcom/android/settings/DataUsageSummary$WarningEditorFragment$2;

    move-object/from16 v2, p0

    invoke-direct/range {v1 .. v9}, Lcom/android/settings/DataUsageSummary$WarningEditorFragment$2;-><init>(Lcom/android/settings/DataUsageSummary$WarningEditorFragment;Landroid/widget/EditText;Landroid/content/Context;IILcom/android/settings/net/NetworkPolicyEditor;Landroid/net/NetworkTemplate;Lcom/android/settings/DataUsageSummary;)V
    ...
    .line 2333
    .end local v5    # "warningValue":I
    .end local v6    # "maxValue":I
    .end local v17    # "warningValueStr":Ljava/lang/String;
    :cond_0
    const v6, 0x7fffffff
    ...
    .line 2338
    .restart local v5    # "warningValue":I
    .restart local v6    # "maxValue":I
    .restart local v17    # "warningValueStr":Ljava/lang/String;
    :cond_1
    const/4 v1, 0x0
...
.method public show(Lcom/android/settings/DataUsageSummary;)V
    ...
    iget-object v2, p0, Lcom/android/settings/DataUsageSummary$WarningEditorFragment;->this$0:Lcom/android/settings/DataUsageSummary;

    invoke-direct {v1, v2}, Lcom/android/settings/DataUsageSummary$WarningEditorFragment;-><init>(Lcom/android/settings/DataUsageSummary;)V
