...
.method public constructor <init>(Lcom/android/settings/deviceinfo/MiscFilesHandler;Landroid/app/Activity;)V
    ...
    iget-object v6, p0, Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter;->mData:Ljava/util/ArrayList;

    invoke-virtual {v6}, Ljava/util/ArrayList;->size()I

    move-result v6

    invoke-direct {v4, v6}, Landroid/util/SparseBooleanArray;-><init>(I)V

    invoke-static {p1, v4}, Lcom/android/settings/deviceinfo/MiscFilesHandler;->access$102(Lcom/android/settings/deviceinfo/MiscFilesHandler;Landroid/util/SparseBooleanArray;)Landroid/util/SparseBooleanArray;
    ...
    iget-wide v6, p0, Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter;->mDataSize:J

    iget-wide v8, v1, Lcom/android/settings/deviceinfo/StorageMeasurement$FileInfo;->mSize:J

    add-long/2addr v6, v8

    iput-wide v6, p0, Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter;->mDataSize:J
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-static {v4}, Lcom/android/settings/deviceinfo/MiscFilesHandler;->access$1600(Lcom/android/settings/deviceinfo/MiscFilesHandler;)Landroid/view/LayoutInflater;
    ...
    invoke-static {v4}, Lcom/android/settings/deviceinfo/MiscFilesHandler;->access$100(Lcom/android/settings/deviceinfo/MiscFilesHandler;)Landroid/util/SparseBooleanArray;
    ...
    invoke-virtual {v2, p1, v4}, Landroid/widget/AbsListView;->setItemChecked(IZ)V
    ...
    invoke-direct {v5, p0, v1, v2}, Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter$1;-><init>(Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter;ILandroid/widget/ListView;)V
    ...
    invoke-direct {v4, p0, v2, v3, v1}, Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter$2;-><init>(Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter;Landroid/widget/ListView;Lcom/android/settings/deviceinfo/FileItemInfoLayout;I)V
    ...
    invoke-direct {v4, p0, v3, v1, v2}, Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter$3;-><init>(Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter;Lcom/android/settings/deviceinfo/FileItemInfoLayout;ILandroid/widget/ListView;)V
    ...
    :cond_1
    invoke-virtual {v2, p1, v7}, Landroid/widget/AbsListView;->setItemChecked(IZ)V
...
.method public isChecked(I)Z
    ...
    .prologue
    .line 404
    iget-object v0, p0, Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter;->this$0:Lcom/android/settings/deviceinfo/MiscFilesHandler;
