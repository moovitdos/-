...
# static fields
.field private static final SUPPORT_SMARTFREN_FEATURE:Z
...
.field private mConnectionStatesPref:Landroid/preference/Preference;
...
.field private mUnpairPref:Landroid/preference/Preference;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 77
    const-string v0, "ro.bt.smartfren.feature"
    ...
    sput-boolean v0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->SUPPORT_SMARTFREN_FEATURE:Z
...
.method private getConnectionTitle()I
    .locals 6
    ...
    invoke-virtual {v0, v3}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->getProfileConnectionState(Lcom/android/settings/bluetooth/LocalBluetoothProfile;)I
...
.method private refresh()V
    ...
    .line 336
    invoke-direct {p0}, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->getConnectionSummary()I

    move-result v1

    .line 338
    .local v1, "summaryResId":I
    sget-boolean v3, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->SUPPORT_SMARTFREN_FEATURE:Z

    if-eqz v3, :cond_0

    .line 339
    invoke-direct {p0}, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->getConnectionTitle()I

    move-result v2

    .line 340
    .local v2, "titleId":I
    iget-object v3, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->mConnectionStatesPref:Landroid/preference/Preference;
    ...
    .line 348
    :goto_0
    iget-object v6, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->mConnectionStatesPref:Landroid/preference/Preference;
    ...
    .line 349
    iget-object v3, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->mUnpairPref:Landroid/preference/Preference;
    ...
    invoke-virtual {v6}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->isBusy()Z
...
.method private showOrHideProfileGroup()V
    ...
    iget-object v2, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->mConnectionStatesPref:Landroid/preference/Preference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 114
    const-string v4, "connection_states"

    invoke-virtual {p0, v4}, Landroid/preference/PreferenceFragment;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v4

    iput-object v4, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->mConnectionStatesPref:Landroid/preference/Preference;
    ...
    iput-object v4, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->mUnpairPref:Landroid/preference/Preference;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 247
    :cond_0
    const-string v3, "connection_states"
    ...
    invoke-virtual {v3}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->disconnect()V
    ...
    invoke-virtual {v3, v2}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->connect(Z)V
...
.method public onResume()V
    ...
    invoke-virtual {v5, v6}, Lcom/android/settings/bluetooth/LocalBluetoothManager;->setForegroundActivity(Landroid/content/Context;)V
