...
.method private static addItem(Ljava/util/List;Ljava/lang/String;Ljava/lang/String;J)V
    ...
    .line 300
    const-string v6, "name_pingying"

    invoke-static {p2}, Lcom/sprd/settings/utils/HanziToPinyin;->getPingYinFormString(Ljava/lang/String;)Ljava/lang/String;
...
.method public static constructTimezoneAdapter(Landroid/content/Context;ZI)Landroid/widget/SimpleAdapter;
    ...
    invoke-static {}, Lcom/android/settings/ZonePicker;->isChineseLanguage()Z

    move-result v1

    if-eqz v1, :cond_0

    const-string v7, "name_pingying"
