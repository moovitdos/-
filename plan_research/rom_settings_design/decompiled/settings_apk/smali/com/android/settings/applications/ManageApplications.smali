...
.method static synthetic access$1000(Lcom/android/settings/applications/ManageApplications;)Lcom/android/internal/app/IMediaContainerService;
    .locals 1
...
.method static synthetic access$1002(Lcom/android/settings/applications/ManageApplications;Lcom/android/internal/app/IMediaContainerService;)Lcom/android/internal/app/IMediaContainerService;
    .locals 0
    .param p0, "x0"    # Lcom/android/settings/applications/ManageApplications;
...
.method static synthetic access$700(Lcom/android/settings/applications/ManageApplications;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/applications/ManageApplications;
...
.method static synthetic access$800(Lcom/android/settings/applications/ManageApplications;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/applications/ManageApplications;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const-string v1, "filter_app_item"
    ...
    .line 856
    :cond_0
    const-class v1, Lcom/android/settings/Settings$SprdManageApplicationsActivity;
    ...
    invoke-virtual {v1, v0, v2, v9}, Landroid/content/ContextWrapper;->bindService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    .line 858
    :cond_4
    const-class v1, Lcom/android/settings/Settings$SprdManageTasksActivity;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iget-object v2, p0, Lcom/android/settings/applications/ManageApplications;->mInflater:Landroid/view/LayoutInflater;

    iget-object v3, p0, Lcom/android/settings/applications/ManageApplications;->mContentContainer:Landroid/view/ViewGroup;
...
.method public onDestroyView()V
    ...
    invoke-virtual {v1}, Lcom/android/settings/applications/ManageApplications$ApplicationsAdapter;->release()V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-static {v4}, Lcom/android/settings/applications/ManageApplications$TabInfo;->access$600(Lcom/android/settings/applications/ManageApplications$TabInfo;)Lcom/android/settings/applications/RunningProcessesView;
    ...
    invoke-static {v2}, Lcom/android/settings/applications/ManageApplications$TabInfo;->access$600(Lcom/android/settings/applications/ManageApplications$TabInfo;)Lcom/android/settings/applications/RunningProcessesView;
    ...
    .line 1205
    new-instance v1, Lcom/sprd/settings/applications/KillApps;

    invoke-virtual {p0}, Landroid/app/Fragment;->getActivity()Landroid/app/Activity;

    move-result-object v2

    iget-object v4, p0, Lcom/android/settings/applications/ManageApplications;->mam:Landroid/app/ActivityManager;

    iget-object v5, p0, Lcom/android/settings/applications/ManageApplications;->mpm:Landroid/content/pm/PackageManager;

    invoke-direct {v1, v2, v4, v5}, Lcom/sprd/settings/applications/KillApps;-><init>(Landroid/content/Context;Landroid/app/ActivityManager;Landroid/content/pm/PackageManager;)V

    .line 1206
    .local v1, "rpu":Lcom/sprd/settings/applications/KillApps;
    invoke-virtual {v1}, Lcom/sprd/settings/applications/KillApps;->killService()V

    .line 1207
    invoke-virtual {v1}, Lcom/sprd/settings/applications/KillApps;->killApp()V
...
.method updateOptionsMenu()V
    ...
    invoke-static {v1}, Lcom/android/settings/applications/ManageApplications$TabInfo;->access$600(Lcom/android/settings/applications/ManageApplications$TabInfo;)Lcom/android/settings/applications/RunningProcessesView;
