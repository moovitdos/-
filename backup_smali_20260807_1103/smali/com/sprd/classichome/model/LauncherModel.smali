...
.method public static forceReloadApps(Landroid/content/Context;)V
    ...
    iget-object v1, v0, Lcom/sprd/classichome/HomeApplication;->mModel:Lcom/sprd/classichome/model/LauncherModel;

    if-eqz v1, :cond_done

    const/4 v2, 0x1

    iput-boolean v2, v1, Lcom/sprd/classichome/model/LauncherModel;->mNeedForceLoad:Z

    iget-object v2, v1, Lcom/sprd/classichome/model/LauncherModel;->mLoaderTask:Lcom/sprd/classichome/model/LauncherModel$LoaderTask;

    if-eqz v2, :cond_done

    invoke-virtual {v2}, Lcom/sprd/classichome/model/LauncherModel$LoaderTask;->isLoading()Z
    ...
    invoke-static {v2}, Lcom/sprd/classichome/model/LauncherModel;->runOnWorkerThread(Ljava/lang/Runnable;)V
