...
.method public applyCustomSettings()V
    ...
    if-eqz v0, :cond_clock_done

    iget-object v1, p0, Lcom/sprd/classichome/HomeStatusView;->mContext:Landroid/content/Context;

    invoke-static {v1}, Lcom/sprd/classichome/settings/LauncherSettings;->isClockEnabled(Landroid/content/Context;)Z

    move-result v1

    if-eqz v1, :cond_clock_hide
    ...
    invoke-static {v1}, Lcom/sprd/classichome/settings/LauncherSettings;->getClockSize(Landroid/content/Context;)I
    ...
    invoke-virtual {v0, v2, v1}, Landroid/widget/TextClock;->setTextSize(IF)V

    iget-object v1, p0, Lcom/sprd/classichome/HomeStatusView;->mContext:Landroid/content/Context;

    invoke-static {v1}, Lcom/sprd/classichome/settings/LauncherSettings;->getClockColor(Landroid/content/Context;)I
    ...
    invoke-static {v1}, Lcom/sprd/classichome/settings/LauncherSettings;->getClockFontStyle(Landroid/content/Context;)I
    ...
    if-eqz v0, :cond_date_done

    iget-object v1, p0, Lcom/sprd/classichome/HomeStatusView;->mContext:Landroid/content/Context;

    invoke-static {v1}, Lcom/sprd/classichome/settings/LauncherSettings;->isDateEnabled(Landroid/content/Context;)Z

    move-result v1

    if-eqz v1, :cond_date_hide
    ...
    invoke-static {v1}, Lcom/sprd/classichome/settings/LauncherSettings;->getDateSize(Landroid/content/Context;)I
    ...
    invoke-static {v1}, Lcom/sprd/classichome/settings/LauncherSettings;->getDateColor(Landroid/content/Context;)I
    ...
    if-eqz v0, :cond_lunar_done

    iget-object v1, p0, Lcom/sprd/classichome/HomeStatusView;->mContext:Landroid/content/Context;

    invoke-static {v1}, Lcom/sprd/classichome/settings/LauncherSettings;->isHebrewDateEnabled(Landroid/content/Context;)Z

    move-result v1

    if-eqz v1, :cond_lunar_hide
